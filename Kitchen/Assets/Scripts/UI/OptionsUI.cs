...
public class OptionsUI : MonoBehaviour
{
    ...
    private void UpdateVisual()
    {
        ...
        interactAltText.text = GameInput.Instance.GetBinding(GameInput.Binding.InteractAlternative);
        ...
        gamepadInteractAltText.text = GameInput.Instance.GetBinding(GameInput.Binding.Gamepad_InteractAlternative);
