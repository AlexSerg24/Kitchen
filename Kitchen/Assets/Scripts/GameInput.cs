...
public class GameInput : MonoBehaviour
{
    ...
    public enum Binding { Move_Up, Move_Down, Move_Left, Move_Right, Interact, InteractAlternative, Pause, Gamepad_Interact, Gamepad_InteractAlternative, Gamepad_Pause }
